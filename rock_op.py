...
class FLORA_GEN_PT_RockOperator(bpy.types.Operator):
    bl_idname = "wm.rock_operator"
    bl_label = "Rock Operator"
    location = "VIEW_3D"
    
    name: bpy.props.StringProperty(name ="name", default = "Rock", maxlen = 100)
    ...
    rock_radius: bpy.props.IntProperty(default = 10, name = "Rock Radius")
    resolution: bpy.props.IntProperty(default = 3, name = "Resolution")
    hight_scalar: bpy.props.FloatProperty(default = 1, name = "Height Scalar")
    num_rings: bpy.props.IntProperty(default = 3, name = "Number of Rings")

    h_scale: bpy.props.FloatProperty(default = 3, name = "H Scalar")
    lacunarity: bpy.props.FloatProperty(default = 1, name = "Lacunarity")
    octaves: bpy.props.FloatProperty(default = 2, name = "Number of Octaves")
    ...
    def execute(self, context):
        ...
        mesh_ops.rock_gen( name=self.name,
    ...
    def menu_func(self, context):
        self.layout.operator(FLORA_GEN_PT_RockOperator.bl_idname)